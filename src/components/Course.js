  ...
  return (
    <CourseCard>
      ...
      <div className='item-btns flex'>
        ...
        <button type='sumbit' className='item-btn add-to-cart-btn' onClick={() => {addToCart(id, image, course_name, creator, discounted_price, category);alert("add item in cart successfully!!")}}>Add to cart</button>
      </div>
    </CourseCard>
  )
}
